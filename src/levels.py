...
level_2_data = {
    ...
    'enemies': [
        {'type': 'terrorist', 'x': 15 * TILE_SIZE, 'y': 400},
        {'type': 'gunman', 'x': 25 * TILE_SIZE, 'y': 400},
        {'type': 'terrorist', 'x': 35 * TILE_SIZE, 'y': 400},
        {'type': 'gunman', 'x': 45 * TILE_SIZE, 'y': 400},
    ...
    'platforms': {
        'standard': [
            {'x': 0, 'y': 8 * TILE_SIZE, 'tiles': 60},
            {'x': -10 * TILE_SIZE, 'y': 1 * TILE_SIZE, 'tiles': 20},
            {'x': 25 * TILE_SIZE, 'y': 5 * TILE_SIZE, 'tiles': 6},
            {'x': 35 * TILE_SIZE, 'y': 3 * TILE_SIZE, 'tiles': 10},
            {'x': 45 * TILE_SIZE, 'y': 1 * TILE_SIZE, 'tiles': 6},
            {'x': 50 * TILE_SIZE, 'y': -2 * TILE_SIZE, 'tiles': 8},
            {'x': 40 * TILE_SIZE, 'y': -4 * TILE_SIZE, 'tiles': 6},
            {'x': 18 * TILE_SIZE, 'y': -7 * TILE_SIZE, 'tiles': 25}
        ],
        'solid': [
            {'x': 0, 'y': 9 * TILE_SIZE, 'repeat': 60},
            {'x': 0, 'y': 10 * TILE_SIZE, 'repeat': 60},
            ...
            {'x': -10 * TILE_SIZE, 'y': 2 * TILE_SIZE, 'repeat': 20},
            {'x': -10 * TILE_SIZE, 'y': 3 * TILE_SIZE, 'repeat': 20},
          
        ],
        'moving': [
            {'x': 30 * TILE_SIZE, 'y': 2 * TILE_SIZE, 'tiles': 2, 'range': 3 * TILE_SIZE, 'direction': 1},
            {'x': 15 * TILE_SIZE, 'y': -3 * TILE_SIZE, 'tiles': 2, 'range': 2 * TILE_SIZE, 'direction': -1}
        ]
    }
}
...
online_multiplayer_data = {
    ...
    'objects': [
            {'type': 'power ups', 'x':58*64 , 'y':400, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':57*64, 'y': 400, 'subtype': 'super power'},
            {'type': 'power ups', 'x':56*64 , 'y':400, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':2*64, 'y': 400, 'subtype': 'super power'},
            {'type': 'power ups', 'x':3*64 , 'y':400, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':4*64, 'y': 400, 'subtype': 'super power'},
            {'type': 'power ups', 'x':27*64 , 'y':400, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':28*64, 'y': 400, 'subtype': 'super power'},
            {'type': 'power ups', 'x':32*64 , 'y':400, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':33*64, 'y': 400, 'subtype': 'super power'},
            {'type': 'power ups', 'x':25*64 , 'y':-200, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':35*64, 'y': -200, 'subtype': 'super power'},
            {'type': 'power ups', 'x':58*64 , 'y':-200, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':57*64, 'y': -200, 'subtype': 'super power'},
            {'type': 'power ups', 'x':56*64 , 'y':-200, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':2*64, 'y': -200, 'subtype': 'super power'},
            {'type': 'power ups', 'x':3*64 , 'y':-200, 'subtype': 'double jump'},
            {'type': 'power ups', 'x':4*64, 'y': -200, 'subtype': 'super power'},
            {'type': 'defusekit', 'x': 58*64, 'y': 400},
            {'type': 'powerbox',  'x': 58*64, 'y': 400},
            {'type': 'powerbox',  'x': 57*64, 'y': 400},
            {'type': 'powerbox',  'x': 32*64, 'y': 400},
            {'type': 'powerbox',  'x': 2*64, 'y': 400},
            {'type': 'powerbox',  'x': 3*64, 'y': 400},
            {'type': 'powerbox',  'x': 28*64, 'y': 400},
